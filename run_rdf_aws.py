...
def run_rdf(args: Namespace):
    ...
    for _, _, files in os.walk(args.data_dir):  # Loop through files in data_dir
        for f in files:
            ...
            os.system('mpirun ' + args.lammps_executable + ' -i ' + args.make_file_name)
...
def main():
    ...
    parser.add_argument('--lammps_executable', type=str, dest='lammps_executable',
                        default='/home/ubuntu/lammps-12Dec18/build/lmp', help='LAMMPS script name')
